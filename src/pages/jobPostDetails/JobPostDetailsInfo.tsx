...
interface JobPostDetailsInfoProps {
...
const formatExperienceRange = (experience: JobPost["experience"]) => {
...
const JobPostDetailsInfo = ({ jobPost, isLoading }: JobPostDetailsInfoProps) => {
  if (isLoading) {
    return <JobPostDetailsSkeleton />;
  }
...
export default JobPostDetailsInfo;
